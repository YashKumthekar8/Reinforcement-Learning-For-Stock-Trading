...
# he maximum drawdown represents the largest percentage decline from a peak to a trough in
#  the portfolio’s value.
# To compute it, we need to find the highest peak (end of a growth period) and the lowest
#  trough (start of a decline period) in the portfolio’s value.
